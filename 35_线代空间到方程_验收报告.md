...
> 来源：`kaoyan-math1-papers` 仓库 `claude/postgraduate-math-exam-szkbdo` 分支，`练习/线代空间到方程_10题_v1/05_Opus验收报告.md`，提交 01c9d133c9d8a554eb0ff32dc60825decca85150（题面 v2）。2026-09-11 迁入本工作包统一管理；原目录保留只作追溯，后续以本文件为准。正文中出现的 `00`—`05` 文件名指原目录，本包对应文件见 `33_线代空间到方程_审查交接与StageA.md` 开头的对照表。
