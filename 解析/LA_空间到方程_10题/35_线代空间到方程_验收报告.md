...
元信息：批次 LA | 卷版本 v2 | 更新 2026-09-11 | 状态 independent_review_done, protocol_validation_incomplete | 可见性 解析（含答案线索，作答前不打开） | 学生卷 `../../题库/LA_空间到方程_10题/22_线代空间到方程_10题.md`

> 来源：`kaoyan-math1-papers` 仓库 `claude/postgraduate-math-exam-szkbdo` 分支，`练习/线代空间到方程_10题_v1/05_Opus验收报告.md`，提交 01c9d133c9d8a554eb0ff32dc60825decca85150（题面 v2）。2026-09-11 迁入本工作包统一管理；原目录保留只作追溯，后续以本文件为准。正文中出现的 `00`—`05` 文件名指原目录，本包对应文件见 `../../审查/LA_空间到方程_10题/33_线代空间到方程_审查交接与StageA.md` 开头的对照表。
